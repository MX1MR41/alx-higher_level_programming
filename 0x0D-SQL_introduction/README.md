# MySQL - Introduction
Project done during **Full Stack Software Engineering studies** at **LALX-Holberton School**. It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements and functions.
